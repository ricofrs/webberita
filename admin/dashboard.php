            ...
            <div class="col-md-4">
               <div class="card-box h-100">
                  <div class="card-header">
                     ...
                     <span class="d-block mb-4 text-nowrap">CRUD</span>
                  </div>
                  <br><br>
                  ...
                  <div class="card-body">
                     <div class="row ">
                        <div class="col-md-6">
                           <h1 class="display-6 text-primary mb-2 pt-4 pb-1">SPORT <br> NEWS</h1>
                           <small class="d-block mb-3">You can control the website from this portal</small>
                           <br>
                           <br>
                           <a href="http://localhost/news/" target="a_blank" class="btn btn-sm btn-primary">Visit Website</a>
                        </div>
                        <div class="col-md-6">
